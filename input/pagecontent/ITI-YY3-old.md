...
#### 2:3.YY3.4.1 Retrieve Trust List Request Message
...
#### 2:3.YY3.4.2 Retrieve Trust List Response Message 
...
All Retrieve Trust List interactions SHOULD occur over secure channels using TLS 1.2 or higher, with mTLS recommended for enhanced endpoint authentication. The Trust Anchor SHOULD validate the authenticity, scope, and expiration of all retrieved key material before publishing or caching.
